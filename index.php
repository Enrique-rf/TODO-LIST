                    ...
                    <?php foreach ($registros as $registro) { ?>
                        <li class="list-group-item">
                            ...
                            <form action="" method="post">
                                ...
                                <input class="form-check-input float-start" type="checkbox" name="completado" value="<?php echo $registro['completar']; ?>" id="" onChange="this.form.submit()" <?php echo ($registro['completar'] == 1) ? 'checked' : ''; ?>>

                            </form>

                            &nbsp;
                            <span class="float-start <?php echo ($registro['completar'] == 1) ? 'subrayado' : ''; ?>">
